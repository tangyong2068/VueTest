...
export default{
  ...
  route:{
    activate:function (){
      this.getProjectList('pacrticipate',this.projectname,this.pagenow,this.pagesize)
    }
  },
  watch:{
  ...
  methods:{
    ...
    deleteProject:function(id){
      swal({
        ...
        if (isConfirm) {
          this.projectname = ""
          this.deleteProjectList('pacrticipate',id,this.projectList.dataList.length,this.pagenow,this.pagesize)
        }
      });
