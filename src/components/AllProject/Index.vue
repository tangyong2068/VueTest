...
export default{
  ...
  route:{
    activate:function (){
      this.getProjectList('all',this.projectname,this.pagenow,this.pagesize)
    }
  },
  watch:{
  ...
  methods:{
    ...
    deleteProject:function(id){
      swal({
        ...
        if (isConfirm) {
          this.projectname = ""
          this.deleteProjectList('all',id,this.projectList.dataList.length,this.pagenow,this.pagesize)
        }
      });
