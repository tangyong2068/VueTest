<template>
  <div class="user-model" v-if = "show">
  ...
  methods:{
    ...
    uploadAvator(thefile){
      ...
      if(file) {
        ...
        if ((filextension.toUpperCase()!='.JPG')&&(filextension.toUpperCase()!='.GIF')&&(filextension.toUpperCase()!='.JPEG')&&(filextension!='.PNG')&&(filextension.toUpperCase()!='.BMP'))
        {
